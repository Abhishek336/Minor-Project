...
<body>
    <div class="alumnimain">
        ...
        <div class="content">
            Develop a fully connected, strong Maharaja Surajmal Institute alumni community.<br>
        </div>
        <div class="subheading">
            <b>MISSION</b>
        </div>
        <div class="content">
            Promote alumni relationships, develop student engagement, and allow student-alumni interactions to benefit Maharaja Surajmal Institute.
